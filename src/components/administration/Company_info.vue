        ...
        <div style="padding-top:44px">
            <div style="position:relative;width:100%;">
                <h4 style="position:absolute;top:-34px;left:0;width:100%;box-sizing:border-box;">岗位管理
                    <div class="button-list">
                        ...
                        <button :style="{background:bgColor,borderColor:bgColor,color:'#fff'}" @click="add()">添加岗位</button>
                    </div>
                </h4>
            </div>
            <div style="width:100%;height:100%;" ref="tableHeight">
                <el-table ref="multipleTable" :data="positionList" style="width: 100%"
                    ...
                    <el-table-column label="操作" fixed width="70">
                        <template slot-scope="scope">
                            <p class="operation">
                            <span @click="editPost(scope.row)" class="editIcon editIcon1"></span>
                            <span class="delete  editIcon" @click="deletePost(scope.row)"></span>
                            </p>
                        </template>
                    </el-table-column>
    ...
    methods:{
        ...
        add(){//添加岗位
            this.postObj={
                ...
                sort:this.positionList.length+1,
            };
            this.isAdds=true;
        },
        editPost(data){//编辑岗位
