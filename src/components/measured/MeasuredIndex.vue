    ...
    <div class="proj-box">
        <div class="page-content-h-3">
          <div style="width:339px;float:left;padding-right:10px;box-sizing:border-box">
            <div class="box-style" style="height:100%">
              <div class="statistics">
                <h4 style="margin-bottom:12px">测量率</h4>
          ...
          <div class="box-style" style="width:329px;float:left;padding-right:10px;">
             <div class="statistics">
                <h4 style="margin-bottom:12px">实测合格率</h4>
                <div class="circle-left" style="text-align:right;padding-right:20px">
          ...
          <div class="box-style" style="width:329px;float:left">
             <div class="statistics">
                <h4 style="margin-bottom:12px">整改完结率</h4>
                <div class="circle-left" style="text-align:right;padding-right:20px">
            ...
            <div class="content-box">
              ...
              <div>
                ...
                <div style="height:100%;width:100%">
                  <ve-histogram :data="chartData" :extend="chartExtend" :colors="colors" :grid="grid" :yAxis="yAxis" :legend-visible="false" height="200px"></ve-histogram>
                </div>
              </div>
            </div>
             <i class="box-style-top-left"></i>
    ...
    methods:{
          ...
          this.util.restGet('/api_v1/construction/inspect/measureChartsData', params, (res)=> {
              ...
              if(res.status==200&&res.data!=undefined){
                res.data.forEach(item=>{
                  item.percent = item.totalNum==0? 0:item.measuredNum*100/item.totalNum;
                  item.passPercent = item.measuredNum==0? 0:item.passNum*100/item.measuredNum;
                });
                this.numberChartData= {
                  columns: ['dataDate', 'rectifyNum'],
                  rows: res.data
                }
                ...
                this.passPercentChartData= {
                  columns: ['dataDate', 'passPercent'],
                  rows: res.data
                }
                // res.data.forEach(item=>{
      ...
      loadStatisticTableData() {//获取统计表格数据
          ...
          this.util.restGet('/api_v1/construction/inspect/measureTableData', params, (res)=> {
              console.log("measureTableData======",res);
              this.util.unmask();
            if(res.status==200&&res.data!=undefined){
              res.data.forEach(item=>{
      ...
      drawCharts(){
          if(this.activeChartStr=="percent"){
              ...
              this.chartData=this.passPercentChartData;
          }else{
