...
//          this.util.restDelete("/api_v1/construction/inspect/batchDeleteCheckItem?ids="+deleteId,null,(res)=>{
      ...
      loadData(){
          this.util.mask();
          this.util.restGet('/api_v1/construction/inspect/checkItemCatalog', {projUid:this.selectProjectObj.id,formType:'measured'}, (res)=> {
              console.log(res);
              this.util.unmask();
              if(res.status==200){
...
//         this.mainData.FORM_TYPE_  = 'problem'
