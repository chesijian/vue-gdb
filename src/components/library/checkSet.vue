  ...
  <div class="Documents">
    <div class="conter clear">
      <div class="conter_left" style="padding-bottom: 55px;box-sizing: border-box;">
        ...
        <div class="aside-box" style="height:100%;overflow-y:auto;">
        ...
        <div class="conter_right_box">
          ...
          <div class="aside-box" style="height:100%;" ref="tablebox">
            <el-table :data="tableData" :height="tableHeightNum" border @selection-change="handleSelectionChange">
              ...
              <el-table-column prop="checkItemNo"  label="编号" ></el-table-column>
              <el-table-column prop="checkItemName"  label="检查项" ></el-table-column>
              <el-table-column prop="checkItemClaim" label="规范要求"></el-table-column>
              <el-table-column prop="minCount" label="最小抽样量" width="110"></el-table-column>
...
<script>
  ...
  export default {
    ...
    created(){
    	console.log('1',this.$store.state.projectName)
      console.log('13',this.$store.state.projPurpose)
...
//        	this.util.restGet('/api_v1/construction/inspect/getCheckItemEnterprise', list, (res)=> {
      ...
      editMember(item){//编辑检查项
      	console.log(item)
//    	  this.mainData.NAME_ =checkItemName;
//              this.mainData.CHECK_REQUIRE_ =data;
//              this.mainData.MIN_SAMPLE_=data;
        this.mainData={
        	id:item.id,
        	TYPE_:item.type,
        	SORT_:item.sort,
          PROJ_TYPE_:item.projType,
          LB_:item.lb,
          NAME_ :item.checkItemName,
          CHECK_REQUIRE_:item.checkItemClaim,
          MIN_SAMPLE_:item.minCount
...
//        	this.util.restGet('/api_v1/construction/inspect/getCheckItemEnterprise', list, (res)=> {
              this.util.unmask();
              console.log('res1231232133333xsd',res)
              if(res.data==undefined){
              	  res.data[0].parentUid="root_quality";
                  res.data[1].parentUid="root_safety";
                  res.data[2].parentUid="root_sanset";
                this.models=res.data;
                
              }else{
//              this.$set(res.data,"children",res.data);
							this.$forceUpdate();
              }
          });
...
//        this.util.restGet('/api_v1/construction/inspect/getCheckItemData', params, (res)=> {
					this.util.restGet('/api_v1/construction/inspect/getCheckItemEnterpriseList', params, (res)=> {
