        ...
        <div class="main_center fl">
            <div class="center_text" style="position: relative;">
                ...
                <div class="linshi_zdy search-box">
                    <input type="text" v-model="mapSearch" @keyup.enter="getProjMapData('search')">
                    <i></i>
                    <button @click="getProjMapData('search')">搜索</button>
                </div>
                <div style="width:100%;height:610px;">
                      <!-- <ve-map :data="mapChartData" height="610px" :legend-visible="false"></ve-map> -->
                    ...
                    <div class="info" id="text" v-show="mapModel.showInfo">
                        <div class="info-top">
                            <h5>{{mapModel.currentObj.proName}}</h5>
                            ...
                            <div class="proj-progress">
                                ...
                                <!-- <p>项目进度:{{mapModel.currentObj.scheduleNum}}%</p> -->
                            </div>
                        ...
                        <div class="info-bottom">
                            ...
                            <div class="btn-wrap">
                                <!-- <span class="close-btn" @click="mapModel.showInfo = false">关闭</span> -->
                                ...
                                <!-- <span class="home-btn" @click="showProject(mapModel.currentObj)">项目主页</span> -->
                            </div>
                        </div>
                    </div>
                </div>
